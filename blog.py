...
while running:
	...
	if choice.lower() == "n":
		...
		for post in blog_posts:
			...
			rss += "<item><title>{0}</title><link>{3}#post{1!s}</link><description>{2}</description></item>".format(post[0],i,post[1],config.url)
			i -= 1
		blog_posts.reverse()
		contents += "<hr><p>Generated by my Python blog generator.</p></body></html>"
		rss += "</channel></rss>"
