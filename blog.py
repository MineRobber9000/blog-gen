...
def loop(choice):
	if choice.lower() == "n":
		...
		for post in blog_posts:
			...
			i -= 1
		blog_posts.reverse()
		contents += "<hr><p>Generated by <a href='https://github.com/MineRobber9000/blog-gen'>MineRobber's Python blog generator.</a><br><a href='rss.xml'>RSS Feed</a></p></body></html>"
		rss += "</channel></rss>"
